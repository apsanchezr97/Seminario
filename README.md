...
graph TD
    ...
    subgraph id_codespaces ["☁️ GitHub Codespaces — apsanchezr97/Seminario"]
        ...
        subgraph id_contenedor ["📦 Contenedor Linux Efimero | VS Code Server"]
            ...
            subgraph id_fastapi ["⚙️ FastAPI Application | uvicorn | Puerto 8000"]
    ...
    id_fastapi  -->|"Procesa request"| EP2
    id_fastapi  -->|"Procesa request"| EP3

    EP1 -.->|"JSON Response <br> {resultado: Aprobado / Rechazado / En Revision}"| Cliente
